...
from tiktok import getCookie, getDownloadUrl, getDownloadID, getStatus # https://t.me/rxc_official
import urllib.request
TOKEN = '5227940739:AAETabNyVwkvKrmr414Rh9Cs94p5OxdBFG8' # @rxc_official
bot = Bot(token=TOKEN)
...
async def start_command(message: types.Message):
    await bot.send_message(chat_id=message.chat.id, text=' Привет, я помогу тебе скачать видео с TikTok. \n/help - инструкция как скачать видео. \n\n А так же подпишись на канал @rxc_official') # https://t.me/rxc_official
 
@dp.message_handler(commands=['help'])
async def help_command(message: types.Message):
    await bot.send_message(chat_id=message.chat.id, text='Скопируй ссылку на видео TikTok и отправь её мне:') # @rxc_official
...
async def text(message: types.Message):
    if message.text.startswith('https://www.tiktok.com'):
        ...
        await bot.send_message(chat_id=message.chat.id, text='Я тебя не понял, отправь мне ссылку на видео TikTok. А так же подпишись на канал @rxc_official')
